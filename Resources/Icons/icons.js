...
const clockTimeTwo = <MaterialIcons name="timelapse" size={45}  color={allColor['primary-color']}/>


const fileTableBox = <MaterialCommunityIcons name="file-table-box" size={45}  color={allColor['primary-color']}/>
