      ...
      <ScrollView>
        <View style={styles.report_container}>
          <View style={styles.ActionBox_style} >
            <ActionBox title={"Vehicle Wise Fixed Reports"} onAction={() => navigation.navigate("CarReportsFixed")} />
          </View>

          
          <View style={styles.ActionBox_style} >
            <ActionBox title={"Operator Wise Fixed Reports"} onAction={() => navigation.navigate("OperatorReportFixed")} icon={icons.users} />
          </View>
