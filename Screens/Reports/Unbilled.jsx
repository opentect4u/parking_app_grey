...
const Unbilled = ({ navigation }) => {
    ...
    const handleUnbilledPrint = async () => {
        ...
        const extractedData = unbilledData && unbilledData.map(({ receiptNo, date_time_in, vehicle_no }) => {
            ...
            const paddedResult = vehicle_no.toString().slice(-4).padStart(4, '0');
            ...
            // formatTime.toLocaleDateString("en-GB").padStart(7).padEnd(14)
        ...
        let headerPayload = 'UNBILLED REPORT\n'
    ...
    return (
        ...
        <View style={{ flex: 1 }}>
            <CustomHeader title={"Unbilled Reports"} navigation={navigation} />
