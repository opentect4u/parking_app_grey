...
const CarReportsFixed = ({ navigation }) => {
    ...
    async function handleGenerateReport() {
        ...
        setLoading(true)
        console.log("------------------date ----------------",mydateFrom.toISOString(),mydateTo.toISOString())
        getVehicleWiseFixedReports(mydateFrom.toISOString(), mydateTo.toISOString()).then(res => {
            console.log("------------------Vehicle wise reports data ----------------", mydateFrom.toISOString(),"jhjhjhdthdhtdhgfd", mydateTo.toISOString(),"jhjkhkjhk")
            ...
            .catch((error) => {
                setLoading(false)
                console.log("------------------date ----------------", mydateFrom.toISOString(),"jhjhjhdthdhtdhgfd", mydateTo.toISOString(),"jhjkhkjhk")
