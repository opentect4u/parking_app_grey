    ...
    return (
        <View style={{ flex: 1, }}>
            ...
            <ScrollView style={{ flex: 1, margin: 10, backgroundColor: allColor.white, borderRadius: 10, padding: 5 }}>
                ...
                {receiptSettings?.header3_flag != "0" && <View style={{ marginBottom: 10 }}>
                    <Text style={{ marginLeft: 10, marginBottom: 5, color: allColor.black }}>
                        Header3
                    </Text>
                    <View style={styles.sectionStyle}>
                ...
                {receiptSettings?.header4_flag != "0" && <View style={{ marginBottom: 10 }}>
                    <Text style={{ marginLeft: 10, marginBottom: 5, color: allColor.black }}>
                        Header4
                    </Text>
                    <View style={styles.sectionStyle}>
                ...
                {receiptSettings?.footer3_flag != "0" && <View style={{ marginBottom: 10 }}>
                    <Text style={{ marginLeft: 10, marginBottom: 5, color: allColor.black }}>
                        Footer3
                    </Text>
                    <View style={styles.sectionStyle}>
                ...
                {receiptSettings?.footer4_flag != "0" && <View style={{ marginBottom: 10 }}>
                    <Text style={{ marginLeft: 10, marginBottom: 5, color: allColor.black }}>
                        Footer4
                    </Text>
                    <View style={styles.sectionStyle}>
