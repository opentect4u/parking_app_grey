    ...
    if (number) {
      ...
      axios
        ...
        .then(async response => {
          ...
          console.log("dfhbvkjd hjgbnfkjn gkj", datak)
          if (datak.length != 0) {
            ...
            datak = [datak].map(item => {
              const { vehicle_name, date_time_in, ...rest } = item; // Destructure "Price" and capture the rest of the properties
              return {
                ...rest,
                vehicleType: vehicle_name,
                date_time_in: newDateTimeIn.toISOString(),
              ...
              // return { 
              //   ...rest,
              //   vehicleType: vehicle_no, // Change key name from "vehicle_no" to "vehicleType"
              //   date_time_in: newDateTimeIn.toISOString(),
              //   date_time_out: date.toISOString()
              // }; // Create a new object with the modified key name and the rest of the properties
            });
